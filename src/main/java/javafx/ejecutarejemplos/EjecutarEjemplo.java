...
public class EjecutarEjemplo {
    ...
    @FXML
    ToggleGroup tgCategoria;
    @FXML
    RadioButton rbControles;
    @FXML
    RadioButton rbPaneles;
    @FXML
    RadioButton rbPersonalizacion;
    @FXML
    RadioButton rbFxml;
    @FXML
    RadioButton rbManejadores;
    @FXML
    RadioButton rbEventos;
    @FXML
    ListView<Opcion> lvEjemplos;
